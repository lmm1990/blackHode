...
public class WriteMonitorInfo implements IAction {
    ...
    public String execute(HttpServerRequest request) {
        ...
        body.append(String.format("<h3>待处理uv数据数量：%d</h3>",
                MonitorDataHandler.uvDataStatisticsCount.getOrDefault(day, new AtomicLong()).get() -
        ...
        body.append(String.format("<h3>待统计消息数：%d</h3>",
                MonitorDataHandler.kafkaConsumeCount.getOrDefault(day, new AtomicLong()).get() -
